...
/*QUAKED actor_Spetsnaz_e_civ_Dragunov_IR_CZ75_Auto (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "dragunov_ir_sp";
	self.secondaryweapon = "cz75_auto_sp";
	self.sidearm = "cz75_sp";
	self.grenadeWeapon = "frag_grenade_sp";
	self.grenadeAmmo = 0;
	self.csvInclude = "char_spetsnaz.csv";

	self setEngagementMinDist( 512.000000, 0.000000 );
