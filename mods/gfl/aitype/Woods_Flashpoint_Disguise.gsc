...
/*QUAKED actor_Woods_Flashpoint_Disguise (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_specop_barnes_fb"
...
main()
{
	...
	character\c_usa_jungmar_barnes_disguise::main();
}
...
precache()
{
	character\c_usa_jungmar_barnes_disguise::precache();
