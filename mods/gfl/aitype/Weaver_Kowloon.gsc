...
/*QUAKED actor_Weaver_Kowloon (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_blackops_body3_fb"
...
main()
{
	...
	character\c_usa_blackops_weaver_getwet::main();
}
...
precache()
{
	character\c_usa_blackops_weaver_getwet::precache();

	precacheItem("spectre_reflex_sp");
