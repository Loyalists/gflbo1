...
/*QUAKED actor_Weaver_WMD (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.health = 150;
	self.weapon = "ak12_zm";
	self.secondaryweapon = "aug_arctic_acog_silencer_sp";
