...
/*QUAKED actor_Spetsnaz_e_civ_Kiparis_ExtClip (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "kiparis_extclip_sp";
