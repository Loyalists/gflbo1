...
/*QUAKED actor_USBlackops_a_winter_aug_silencer (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "aug_acog_silencer_sp";
...
precache()
{
	...
	precacheItem("aug_acog_silencer_sp");
