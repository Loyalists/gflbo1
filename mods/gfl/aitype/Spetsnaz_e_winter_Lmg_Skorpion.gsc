...
/*QUAKED actor_Spetsnaz_e_winter_Lmg_Skorpion (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.health = 150;
	self.weapon = "rpk_sp";
	self.secondaryweapon = "skorpion_sp";
